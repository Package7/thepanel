...
<html lang="en">
    <head>
        ...
        <link href="<?php echo base_url('public/css/stack-interface.css'); ?>" rel="stylesheet" type="text/css" media="all" />
        <link href="<?php echo base_url('public/css/socicon.css'); ?>" rel="stylesheet" type="text/css" media="all" />
        <link href="<?php echo base_url('public/css/lightbox.min.css'); ?>" rel="stylesheet" type="text/css" media="all" />
        <link href="<?php echo base_url('public/css/flickity.css'); ?>" rel="stylesheet" type="text/css" media="all" />
        <link href="<?php echo base_url('public/css/iconsmind.css'); ?>" rel="stylesheet" type="text/css" media="all" />
        <link href="<?php echo base_url('public/css/jquery.steps.css'); ?>" rel="stylesheet" type="text/css" media="all" />
        <link href="<?php echo base_url('public/css/theme.css'); ?>" rel="stylesheet" type="text/css" media="all" />
        <link href="<?php echo base_url('public/css/custom.css'); ?>" rel="stylesheet" type="text/css" media="all" />
    ...
    <body class=" ">
                            ...
                            <ul class="menu-horizontal">
                                                ...
                                                <section class="imageblock feature-large bg--white border--round ">
                                                    <div class="imageblock__content col-md-5 col-sm-3 pos-left">
                                                        <div class="background-image-holder">
                                                            <img alt="image" src="<?php echo base_url('public/img/cowork-11.jpg'); ?>" />
                                                        </div>
                                                    </div>
                                                    <div class="container">
                                                        <div class="row">
                                ...
                                <li class="dropdown dropdown--absolute">
                                    <span class="dropdown__trigger">
                                        <img alt="Image" class="flag" src="<?php echo base_url('public/img/flag-1.png'); ?>" />
                                    </span>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-3 col-sm-2">
                            <a href="index.html">
                                <img class="logo logo-dark" alt="logo" src="<?php echo base_url('public/img/logo-dark.png'); ?>" />
                                <img class="logo logo-light" alt="logo" src="<?php echo base_url('public/img/logo-light.png'); ?>" />
                            </a>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-11 col-sm-12 text-right text-left-xs text-left-sm">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12 dropdown__content dropdown__content--lg">
                                                        <div class="pos-absolute col-md-5 imagebg hidden-sm hidden-xs" data-overlay="4">
                                                            <div class="background-image-holder">
                                                                <img alt="background" src="<?php echo base_url('public/img/dropdown-1.jpg'); ?>" />
                                                            </div>
                                                            <div class="container pos-vertical-center">
                                                                <div class="row">
                                                                    <div class="col-md-8 col-md-offset-2">
                                                                        <img alt="Logo" src="<?php echo base_url('public/img/logo-light.png'); ?>" class="image--xxs" />
                                                                        <span class="h2 color--white">Beautiful, modular sites in moments.</span>
                                                                        <a href="https://themeforest.net/item/stack-multipurpose-html-with-page-builder/19337626?ref=medium_rare" class="btn btn--primary type--uppercase">
                                                ...
                                                <div class="row">
                                                    <div class="dropdown__content dropdown__content--lg col-md-8">
                                                        <div class="pos-absolute col-md-5 imagebg hidden-sm hidden-xs" data-overlay="6">
                                                            <div class="background-image-holder">
                                                                <img alt="background" src="<?php echo base_url('public/img/inner-6.jpg'); ?>" />
                                                            </div>
                                                            <div class="container pos-vertical-center">
                                                                <div class="row">
                                                                    <div class="col-md-10 col-md-offset-1">
                                                                        ...
                                                                        <a href="http://trystack.mediumra.re/variant/builder.html" class="btn btn--primary type--uppercase">
                                                                            <span class="btn__text">
                                                                                Launch Builder
                                                                            </span>
                                                                        </a>
                                            ...
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-sm-12 dropdown__content dropdown__content--lg">
                                                        <div class="pos-absolute col-md-5 imagebg hidden-sm hidden-xs" data-overlay="4">
                                                            <div class="background-image-holder">
                                                                <img alt="background" src="<?php echo base_url('public/img/dropdown-2.jpg'); ?>" />
                                                            </div>
                                                            <div class="container pos-vertical-center">
                                                                <div class="row">
                                                                    <div class="col-md-8 col-md-offset-2">
                            ...
                            <!--end module-->
                            <div class="bar__module">
                                <a class="btn btn--sm type--uppercase" href="http://trystack.mediumra.re/variant/builder.html">
                                    <span class="btn__text">
                                        Try Builder
                                    </span>
                                </a>
                                <a class="btn btn--sm btn--primary type--uppercase" href="https://themeforest.net/item/stack-multipurpose-html-with-page-builder/19337626?ref=medium_rare">
                                    <span class="btn__text">
                                        Buy Now
                                    </span>
                                </a>
        ...
        <div class="main-container">
            <section class="cover imagebg height-60 text-center" data-overlay="3">
                <div class="background-image-holder">
                    <img alt="background" src="<?php base_url('public/img/knowledge-1.jpg'); ?>" />
                </div>
                <div class="container pos-vertical-center">
                    <div class="row">
                        <div class="col-sm-10 col-md-8">
                            ...
                            <p class="lead">
                                An ideal layout for web-apps that require a knowledge repository.
                            </p>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <a href="#" class="block">
                                <div class="feature boxed boxed--border border--round text-center">
                                    <i class="icon--lg icon-Data-Storage"></i>
                                    <span class="h5 color--primary">Managing Storage</span>
                                </div>
                            </a>
                        </div>
                        <div class="col-sm-3">
                            <a href="#" class="block">
                                <div class="feature boxed boxed--border border--round text-center">
                                    <i class="icon--lg icon-Email"></i>
                                    <span class="h5 color--primary">Mailing and Subscriptions</span>
                                </div>
                            </a>
                        </div>
                        <div class="col-sm-3">
                            <a href="#" class="block">
                                <div class="feature boxed boxed--border border--round text-center">
                                    <i class="icon--lg icon-Brush"></i>
                                    <span class="h5 color--primary">Appearance</span>
                                </div>
                            </a>
                        </div>
                        <div class="col-sm-3">
                            <a href="#" class="block">
                                <div class="feature boxed boxed--border border--round text-center">
                                    <i class="icon--lg icon-Cursor-Click2"></i>
                                    <span class="h5 color--primary">Analytics</span>
                                </div>
                            </a>
                        </div>
                    </div>
            ...
            <section class="bg--primary unpad cta cta-2">
                <a href="https://themeforest.net/item/stack-multipurpose-html-with-page-builder/19337626?ref=medium_rare">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12 text-center">
        ...
        <script src="<?php echo base_url('public/js/flickity.min.js'); ?>"></script>
        <script src="<?php echo base_url('public/js/easypiechart.min.js'); ?>"></script>
        ...
        <script src="<?php echo base_url('public/js/isotope.min.js'); ?>"></script>
        <script src="<?php echo base_url('public/js/ytplayer.min.js'); ?>"></script>
        <script src="<?php echo base_url('public/js/lightbox.min.js'); ?>"></script>
        <script src="<?php echo base_url('public/js/granim.min.js'); ?>"></script>
        <script src="<?php echo base_url('public/js/jquery.steps.min.js'); ?>"></script>
        <script src="<?php echo base_url('public/js/countdown.min.js'); ?>"></script>
        <script src="<?php echo base_url('public/js/twitterfetcher.min.js'); ?>"></script>
        <script src="<?php echo base_url('public/js/spectragram.min.js'); ?>"></script>
        <script src="<?php echo base_url('public/js/smooth-scroll.min.js'); ?>"></script>
