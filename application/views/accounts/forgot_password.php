...
<html lang="en">
    ...
    <title><?php echo get_website_title('Forgot password'); ?></title>
        ...
        <div class="main-content container-fluid">
          <div class="splash-container">
            <div class="panel panel-default panel-border-color panel-border-color-primary">
              <div class="panel-heading"><img src="<?= base_url('public/img/logo-xx.png'); ?>" alt="logo" height="27" class="logo-img"><span class="splash-description">Request new password using personal info.</span></div>
